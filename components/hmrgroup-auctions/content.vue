    ...
    <section>
      <div class="flex justify-center my-10">
        <div class="flex flex-col items-center text-center w-full max-w-5xl p-4 gap-5">
          <h1 ref="title">
            A Secondary Market Ecosystem For Machinery And Industrial Equih1ment.
          </h1>
          <div>
            <img ref="logo" src="/public/images/auctions-logo.png" alt="Auctions Image" class="w-full h-auto">
          </div>
        </div>
      </div>
    </section>
