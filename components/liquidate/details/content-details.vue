        ...
        <div class="flex flex-col justify-center items-center w-full space-y-8">
          ...
          <div class="text-center py-10 lg:py-0">
            ...
            <div ref="mobileparagraph1">
              ...
              <p class="text-gray-600 mx-10 lg:mx-0">Categorize, sort, and store items efficiently to streamline the flow of products through the reverse logistics process. Real-time tracking ensures optimal storage and accessibility.</p>
            </div>
          </div>
          ...
          <div class="text-center py-10 lg:py-0">
            ...
            <div ref="mobileparagraph2">
              ...
              <p class="text-gray-600 mx-10 lg:mx-0">Resell refurbished products through online platforms, physical stores, or B2B channels. This approach extends product life, reduces environmental impact, and offers cost-effective alternatives.</p>
            </div>
          ...
          <div class="text-center py-10 lg:py-0">
            <svg ref="mobileItem3" class="mx-auto"  width="133" height="120" viewBox="0 0 133 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div ref="mobileparagraph3">    
                ...
                <p class="text-gray-600 mx-10 lg:mx-0">Collect surplus, returned, or end-of-life products from suppliers, retailers, or customers. This step reduces waste and sets the foundation for reuse or recycling.</p>            
              </div>
            </div>
          ...
          <div class="text-center py-10 lg:py-0">
            <svg ref="mobileItem4" class="mx-auto" width="150" height="120" viewBox="0 0 150 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div ref="mobileparagraph4">
                ...
                <p class="text-gray-600 mx-10 lg:mx-0">Inspect, repair, and restore products by skilled technicians. Salvaged components from non-repairable items are repurposed to maximize value.</p>
              </div>
