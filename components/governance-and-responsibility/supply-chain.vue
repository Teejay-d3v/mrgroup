<template>
  <div class="grid grid-cols-12 gap-6 bg-blue-900 text-white ">
    <div class="custom-bg col-span-12 py-30 lg:p-10">
      <div class="grid grid-cols-12 gap-4 lg:gap-8 mx-2 lg:mx-10">
        ...
        <div class="col-span-12 p-5">
          <div>
            ...
            <p ref="paragraph1" class="leading-[36px] font-normal text-left">
        ...
        <div ref="sectionRef" class="col-span-12 grid grid-cols-12 gap-4 lg:gap-8 pt-4 lg:py-10 p-5 lg:p-0">
          <div class="flex flex-col lg:flex-row col-span-12 lg:col-span-4 mb-4 lg:mb-0"> 
            <div class="text-center lg:text-left mb-4 lg:mb-0">
              <h2 ref="achievementCounter1" class="font-bold text-[40px] lg:text-[56px] leading-[1] ">0</h2>
              <p class="text-center lg:text-left">Tonnes</p>
            </div>
            <div class="text-center lg:text-left mb-4 lg:mb-0 lg:mx-8"> 
              <h2 ref="achievementCounter2" class="font-bold text-[40px] lg:text-[56px] leading-[1]">0</h2>
              <p class="text-center lg:text-left">Metric Tonnes CO2e prevented</p>
            </div>
          </div>
          <div class="col-span-12 lg:col-span-7 mb-4 lg:mb-0 pr-0 ">
            <h4 ref="title2" >
        ...
        <!-- Three  -->
        <div class="col-span-12 grid grid-cols-12 gap-4 p-5 lg:p-0 text-left">
