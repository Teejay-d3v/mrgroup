<template>
  <div class=" text-white" style="padding: 56px; background: #123567;">
    <div>
      <div class="col-span-12 grid grid-cols-12 gap-8 py-5">
        <div class="flex col-span-4 space-x-14"> 
          <div style="width: 524px; height: auto; gap: 12px;" class="flex flex-col relative"> 
            <button class="bg-slate-600 text-white rounded px-4 py-2 absolute top-0 left-0">OUR SERVICES</button> 
            <h2 class="text-3xl lg:text-4xl font-light text-primary-dark mt-10"> 
              Championing the Circular Economy and Re-Commerce
            </h2>
          </div>
        </div>
        ...
        <div class="col-span-8 flex items-center">
          <div>
            <h2 class="text-lg">
              HMR’s core operational philosophy and business model naturally fit within the circular economy, and HMR has been a champion of Re-Commerce since its foundation.
            </h2>
          </div>
        </div>
      </div>
      ...
      <div class="py-5">
        ...
        <div >
          <ul>
            <li>The modular construction approach.</li>
            <li>Harrington’s Enclave is aiming to be one of the most sustainable inner city developments in Metro Manila.</li>
            <li>Re-salvage : The environmental benefits of Retrofitting shipping containers.</li>
          </ul>
